...
class Entry(Base):
    ...
    entryID = Column(String(APP_GLOBAL_CONFIG.FIELD_CONTENT_ENTRY_SIZE))
    title = Column(String(APP_GLOBAL_CONFIG.FIELD_TITLE_SIZE))
    content = Column(String(APP_GLOBAL_CONFIG.FIELD_CONTENT_ENTRY_SIZE))
